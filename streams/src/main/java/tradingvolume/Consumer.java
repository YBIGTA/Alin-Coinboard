...
public class Consumer {
    ...
    private final static Logger log = LoggerFactory.getLogger(tradingvolume.Consumer.class);
    private final static String TOPIC_NAME = "dev.alin.trading_volume.json";
